...
import telebot
TOKEN = '5212860492:AAHTSVknRN70vYYYP4ohgRvyyGKIW-2ICxI'
...
def lalala(message):
	if message.chat.type == 'private':
		if message.text == '🧡 Мой репозиторий':
			bot.send_message(message.chat.id, 'https://github.com/AlexeyD-qa/cv.git')
		elif message.text == '😋 Написать мне в личку':
			bot.send_message(message.chat.id, '@AlexeyDolyanovsky')
